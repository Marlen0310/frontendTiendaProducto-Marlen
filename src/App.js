...
function App() {
  const baseUrl="http://localhost/apiTiendaProducto/";
...
<br/>
      <button className="btn btn-success" onClick={()=>abrirCerrarModalInsertar()}>Añadir</button>
      <br /><br />
    ...
    <Modal isOpen={modalEliminar}>
        <ModalBody>
        ¿Estás seguro que deseas eliminar el Producto {frameworkSeleccionado && frameworkSeleccionado.nombre}?
        </ModalBody>
        <ModalFooter>
